...
##set_property MARK_DEBUG true [get_nets {sw_IBUF[14]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[1]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[7]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[8]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[11]}]
...
##set_property MARK_DEBUG true [get_nets {sw_IBUF[9]}]
...
##set_property MARK_DEBUG true [get_nets {sw_IBUF[4]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[15]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[5]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[10]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[12]}]
...
##set_property MARK_DEBUG true [get_nets {sw_IBUF[6]}]
##set_property MARK_DEBUG true [get_nets {sw_IBUF[13]}]
...
##connect_debug_port u_ila_0/probe1 [get_nets [list {sw_IBUF[0]} {sw_IBUF[1]} {sw_IBUF[2]} {sw_IBUF[3]} {sw_IBUF[4]} {sw_IBUF[5]} {sw_IBUF[6]} {sw_IBUF[7]} {sw_IBUF[8]} {sw_IBUF[9]} {sw_IBUF[10]} {sw_IBUF[11]} {sw_IBUF[12]} {sw_IBUF[13]} {sw_IBUF[14]} {sw_IBUF[15]}]]
##create_debug_port u_ila_0 probe
